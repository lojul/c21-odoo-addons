...
DISTRICT_SELECTION = [
    ...
    ('kennedy_town', 'Kennedy Town (堅尼地城)'),
    ('happy_valley', 'Happy Valley (跑馬地)'),
    ('tin_hau', 'Tin Hau (天后)'),
    ('fortress_hill', 'Fortress Hill (炮台山)'),
    ('chai_wan', 'Chai Wan (柴灣)'),
    # Kowloon
    ('tsim_sha_tsui', 'Tsim Sha Tsui (尖沙咀)'),
    ('jordan', 'Jordan (佐敦)'),
    ('mong_kok', 'Mong Kok (旺角)'),
    ('prince_edward', 'Prince Edward (太子)'),
    ('yau_ma_tei', 'Yau Ma Tei (油麻地)'),
    ...
    ('whampoa', 'Whampoa (黃埔)'),
    ('hung_hom', 'Hung Hom (紅磡)'),
    ('kai_tak', 'Kai Tak (啟德)'),
    ('to_kwa_wan', 'To Kwa Wan (土瓜灣)'),
    # New Territories
    ...
    ('tai_po', 'Tai Po (大埔)'),
    ('fanling', 'Fanling (粉嶺)'),
    ('sheung_shui', 'Sheung Shui (上水)'),
    ('tseung_kwan_o', 'Tseung Kwan O (將軍澳)'),
    ('ma_on_shan', 'Ma On Shan (馬鞍山)'),
    ('tin_shui_wai', 'Tin Shui Wai (天水圍)'),
    ('tung_chung', 'Tung Chung (東涌)'),
    # Other
    ('other', 'Other (其他)'),
]
